#ifndef GMOD_LUASHARED_H
#define GMOD_LUASHARED_H
#pragma once
...
class QAngle;
struct lua_State;
struct clr_t { unsigned char r, g, b, a; };

typedef int(__cdecl* CFunc)(lua_State*);
...
#define ILUASHARED_INTERFACE "LUASHARED003"
